...
// Dictionary that stores values of type Object indexed by keys of type int
interface DictionaryInterface {
    ...
    // returns null.
    public Object put(int key, Object words);

    public Object get(int key); // Retrieves the value stored with the key.

    public void remove(int key); // Deletes the key/value pair stored with the given key.

    public void clear(); // Empties the dictionary.

    public int[] getKeys(); // Returns an array of all the keys currently stored in the Dictionary.
}